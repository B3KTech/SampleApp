package com.atakmap.android.pulsetool.plugin.ui.settings.widget;
...
public class SettingsSpinner<T> extends LinearLayout
{
    ...
    private String getString(T selectedOption)
    {
        ...
        {
            return com.atakmap.android.pulsetool.plugin.ui.settings.util.TextUtils.toTitleCase((String)selectedOption);
        }
        ...
        try
        {
            ...
            {
                return com.atakmap.android.pulsetool.plugin.ui.settings.util.TextUtils.toTitleCase(mContext.getString(resId));
            }
        }
        catch(Exception e)
        {
        ...
        return com.atakmap.android.pulsetool.plugin.ui.settings.util.TextUtils.toTitleCase(selectedOption.toString());
    }
